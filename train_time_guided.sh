python main.py mydataset RGB Flow STFT STFT_2 --config ./exps/aid_time_guided.json \
    ...
    --lr_steps 10 --gd 50 --partialbn -j 8 --pretrained_flow ./pretrain_model/TSN-kinetics-flow.pth --attr 'vision_guided'