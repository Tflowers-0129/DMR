        ...
        for op in self._op_list:
            if op[1] != 'Concat' and op[1] != 'InnerProduct':
                ...
                try:
                    ...
                    raise
        return data_dict[self._op_list[-1][3]] #before global pooling
        #return data_dict[self._op_list[-1][2]] #after global pooling
...
class BNInception_STFT(nn.Module):
    ...
    def forward(self, input):
        ...
        return data_dict[self._op_list[-1][3]]
        #return data_dict[self._op_list[-1][2]]   1*1
